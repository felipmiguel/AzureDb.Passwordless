...
[Npgsql](https://www.npgsql.org/doc/security.html?tabs=tabid-1) library offers a mechanism that periodically retrieves a password that can be used to create a physical connection to the database. That is `UsePeriodicPasswordProvider` method. The library Sfinks.Azure.Data.Extensions.Npgsql provides a class that implements with a property that can be used to retrieved to obtains the password from Azure AD.
...
type="Sfinks.Azure.Data.Extensions.MySql.AzureIdentityMysqlAuthenticationPlugin, Sfinks.Azure.Data.Extensions.MySql"></add>
    </AuthenticationPlugins>  
  </MySQL>
...
</configuration>
...
There are more usage examples in project [Sfinks.Azure.Data.Extensions.MySqlTests](./Sfinks.Azure.Data.Extensions.MySqlTests/)
...
There is an implementation of this delegate in [Sfinks.Azure.Data.Extensions.MySqlConnector.TokenCredentialMysqlPasswordProvider](./Sfinks.Azure.Data.Extensions.MySqlConnector/TokenCredentialMysqlPasswordProvider.cs) class.
...
namespaceSfinks.Azure.Data.Extensions.Pomelo.EntityFrameworkCore
{
...
There are more usage examples in project [Sfinks.Azure.Data.Extensions.MySqlConnectorTests](./Sfinks.Azure.Data.Extensions.MySqlConnectorTests/)

## Nuget packages

This repository contains the following Nuget packages:

* Sfinks.Azure.Data.Extensions.Npgsql
* Sfinks.Azure.Data.Extensions.MySqlConnector
* Sfinks.Azure.Data.Extensions.Core. This package is referenced by the other two packages.

And here the Entity Framework packages:

* Sfinks.Azure.Data.Extensions.Npgsql.EntityFrameworkCore
* Sfinks.Azure.Data.Extensions.Pomelo.EntityFrameworkCore
* Sfinks.Azure.Data.Extensions.MySql.EntityFrameworkCore
...
* [Sfinks.Azure.Data.Extensions.NpgsqlTests](./Sfinks.Azure.Data.Extensions.NpgsqlTests/)
* [Sfinks.Azure.Data.Extensions.MySqlConnectorTests](./Sfinks.Azure.Data.Extensions.MySqlConnectorTests/)
* [Sfinks.Azure.Data.Extensions.MySqlTests](./Sfinks.Azure.Data.Extensions.MySqlTests/)
